...
//1432853/2101921/2.50/7/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV75533PDRVR" (originalName "TLV75533PDRVR")
	...
	(compDef "TLV75533PDRVR" (originalName "TLV75533PDRVR") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV75533PDRVR"))
		...
		(attr "Manufacturer_Part_Number" "TLV75533PDRVR")
		(attr "Mouser Part Number" "595-TLV75533PDRVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV75533PDRVR?qs=lc2O%252BfHJPVbmKlktYGVy6A%3D%3D")
		(attr "Arrow Part Number" "TLV75533PDRVR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tlv75533pdrvr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "500-mA low-IQ small-size low-dropout (LDO) regulator")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tlv755p")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "TLV75533PDRVR.stp")
